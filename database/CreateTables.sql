...
CREATE TABLE Booking(
                        ...
                        Status  VARCHAR(20) NOT NULL CHECK (Status IN ('booked', 'transformed', 'cancelled','pending')),
                        ...
                        CONSTRAINT fk_Booking_Room
                            FOREIGN KEY (RoomID)
                                ...
                                ON DELETE SET NULL,
                        CONSTRAINT chk_BookingDates CHECK (StartDate < EndDate)
);
...
CREATE TABLE Renting(
                        ...
                        CONSTRAINT fk_Renting_Room
                            FOREIGN KEY (RoomID)
                                REFERENCES Room(RoomID)
                                ON DELETE SET NULL,
                        CONSTRAINT chk_RentingDates CHECK (StartDate < EndDate)
);
